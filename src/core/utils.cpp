...
const char *utils::convert_gd_string(const StringName &s) {
    return convert_gd_string(String(s));
}

const char *utils::convert_gd_string(const String &s) {
...
bool utils::input_pressed(const StringName &name) {
    return Input::get_singleton()->is_action_pressed(name);
}

bool utils::input_down(const StringName &name) {
    return Input::get_singleton()->is_action_just_pressed(name);
}

bool utils::input_up(const StringName &name) {
    return Input::get_singleton()->is_action_just_released(name);
}
}  // namespace godot::aquilia
